...
class CsvProductValidationTest extends WebTestCase
{
    ...
    private const ERROR_MESSAGES = [
        'the SKU is empty',
        'the SKU contains html tags',
        'the description is empty',
        'the description contains html tags',
    ...
    public function testDescriptionValidation() {
        ...
        $csvProduct = new CsvProduct(1, 'lorem ipsum', '<script', '2', '1');
    ...
    public function testNormalPriceValidation() {
        ...
        $csvProduct = new CsvProduct(1, 'lorem ipsum', 'lorem ipsum', '', null);
        ...
        $csvProduct = new CsvProduct(1, 'lorem ipsum', 'lorem ipsum', 'invalid', null);
        ...
        $csvProduct = new CsvProduct(1, 'lorem ipsum', 'lorem ipsum', '-1', null);
    ...
    public function testSpecialPriceValidation() {
        ...
        $csvProduct = new CsvProduct(1, 'lorem ipsum', 'lorem ipsum', '1', '');
        ...
        $csvProduct = new CsvProduct(1, 'lorem ipsum', 'lorem ipsum', '1', 'invalid');
        ...
        $csvProduct = new CsvProduct(1, 'lorem ipsum', 'lorem ipsum', '1', '-1');

        $errors = $this->validator->validate($csvProduct);
        $this->assertEquals(1, $errors->count());
        $this->assertEquals(self::ERROR_MESSAGES[8], $errors->get(0)->getMessage());

        // test special price gt normal price
        $csvProduct = new CsvProduct(1, 'lorem ipsum', 'lorem ipsum', '1', '2');

        $errors = $this->validator->validate($csvProduct);
        $this->assertEquals(1, $errors->count());
        $this->assertEquals(self::ERROR_MESSAGES[9], $errors->get(0)->getMessage());
    }
}